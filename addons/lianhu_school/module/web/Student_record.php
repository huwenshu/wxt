<?php 
				...
				$top_action = array(
					array('action_name'=>'记录分类','action'=>'student_record','arr'=>array('aw'=>1,'ac'=>'class') ),
					array('action_name'=>'新增分类','action'=>'student_record','arr'=>array('aw'=>1,'ac'=>'class','op'=>'edit') ),
					array('action_name'=>'学生记录','action'=>'student_record','arr'=>array('aw'=>1) ),
				);
