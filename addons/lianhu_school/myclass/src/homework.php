...
class homework extends common{
    ...
    public function setBase($school_id=false){
        ...
        $this->day_much =  S("system",'dayWorkMuch',array('get',false,$school_id));
        $this->day_base =  S("system",'dayWorkBase',array('get',false,$school_id));
    }
    //教师时间段内积分数
    ...
    //获取有效的作业记录
    public function getHomeworkList($begin_time,$end_time){
