...
class common{
    ...
    public function edit($where,$up=false){
        ...
        $result    = pdo_fetch("select ".$field_str." from ".$this->table." where ".$where_str,$in_params);
        return $result;
    }
    //delete
    ...
    public function getList($params,$in_where=false,$pages=1){
        ...
        $list                   = pdo_fetchall("select *  from ".$this->table." where ".$where." order by ".$field." desc limit ".$limit_sql,$params);
