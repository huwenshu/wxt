                                             ...
                                             <?php  if(is_array($last_sends)) { foreach($last_sends as $row) { ?>
                                                <div class="mt-comment">
                                                    <div class="mt-comment-img ">
                                                        <img src="<?php  echo $_W['attachurl'];?><?php  if($row['teacher_result']) { ?><?php  echo $this->getTeacherImg($row['teacher_result']['teacher_id']);?><?php  } else { ?><?php  echo $row['student_info']['student_img'];?><?php  } ?>" style="width:50px;"/> </div>
