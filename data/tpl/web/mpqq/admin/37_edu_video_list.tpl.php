                                                 ...
                                                 <div class="form-group form-md-line-input">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <select name='list_src_type'  class="form-control"  onchange="classLevel(this)">
                                                            <option value='0' <?php  if(0 == $result['list_src_type'] || !$result['list_src_type']  ) { ?> selected <?php  } ?>>流地址模式</option>
                                                            <option value='1' <?php  if(1 == $result['list_src_type']) { ?> selected <?php  } ?>>iframe模式</option>
                                                        </select>                                                         
                                                    </div>
                                                </div>
                                                  <div id='src' class="form-group form-md-line-input" <?php  if($result['list_src_type']==1  ) { ?> style="display:none"<?php  } ?>>
                                                  ...
                                                  <div id='content' class="form-group form-md-line-input" <?php  if($result['list_src_type']==0 || !$result ) { ?> style="display:none"<?php  } ?>>
