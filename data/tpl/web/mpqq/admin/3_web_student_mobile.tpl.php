                         ...
                         <?php  if($op=='list') { ?>
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i>家长端底部导航列表 </div>
                                    <div class="tools">
                                        ...
                                        <tbody>
                                         <?php  if(is_array($button_list)) { foreach($button_list as $item) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a  href="<?php  echo $this->createWebUrl('student_mobile', array('id' => $item['display_id'], 'op' => 'edit','ac'=>'button' ))?> " class="btn btn-outline btn-circle btn-sm purple">
                                                                <i class="fa fa-edit"></i> 编辑
                                                    </a>
                                                     <a  href="<?php  echo $this->createWebUrl('student_mobile', array('id' => $item['display_id'], 'op' => 'delete','ac'=>'button' ))?> " class="btn btn-outline btn-circle btn-sm red">
                                ...
                                <div class="portlet box green">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-cogs"></i>家长端首页控制 </div>
                                        <div class="tools">
                                            <a href="javascript:;" class="collapse"> </a>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table table-bordered table-striped table-condensed flip-content">
                                            ...
                                            <?php  if(is_array($index_list)) { foreach($index_list as $item) { ?>
                                                <tr class="success">
                                                    ...
                                                    <td>
                                                        <a  href="<?php  echo $this->createWebUrl('student_mobile', array('id' => $item['top']['display_id'], 'op' => 'edit','ac'=>'index_top' ))?> " class="btn yellow">
                                                                    <i class="fa fa-edit"></i> 编辑
                                                        </a>
                                                        <a  href="<?php  echo $this->createWebUrl('student_mobile', array('id' => $item['top']['display_id'], 'op' => 'new','ac'=>'index_button' ))?> " class="btn red">
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src='<?php  echo $val['img'];?>' width="70px"></td>
                                                    ...
                                                    <td>
                                                        <a  href="<?php  echo $this->createWebUrl('student_mobile', array('id' => $val['display_id'], 'op' => 'edit','ac'=>'index_button' ))?> " class="btn btn-outline btn-circle btn-sm purple">
                                                                    <i class="fa fa-edit"></i> 编辑
                                                        </a>
                                                        <a  href="<?php  echo $this->createWebUrl('student_mobile', array('id' => $val['display_id'], 'op' => 'delete','ac'=>'button' ))?> " class="btn btn-outline btn-circle btn-sm red">
                                                                <i class="fa fa-close"></i> 删除
                                                        </a>   
                                                    </td>         
                                                </tr>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <?php  if($mu_str=='xiaoye') { ?>
                                                    <?php  if(!$result['xiaoyeimg'] ) { ?>
                                                        <?php  $result['xiaoyeimg'] = C('mobile')->studentButtonImg($result['keyword']); ?>
                                                    <?php  } ?>
                                    ...
                                    <?php  } ?>                                       
                                        ...
                                        <div class="form-group  form-md-line-input">
                                            ...
                                            <div class="col-sm-10">
                                                  <input type="text" name="dis_two" id="dis_two" class="form-control" value='<?php  echo $result['dis_two'];?>' />
                                                  <div class="form-control-focus"> </div>                                             
                                                  <span class="help-block">[填写格式：fa fa-*]<a target="_blank" href='http://fontawesome.io/icons/'>(http://fontawesome.io/icons/)</a>[不要使用最新的图标]</span>
