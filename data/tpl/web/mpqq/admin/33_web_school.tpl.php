                            ...
                            <div class="portlet light ">
                                ...
                                <div class="portlet-body form">
                                    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" id="form1"  >
                                        <div class="form-body">
                                            ...
                                            <div class="form-group form-md-line-input">
                                             ...
                                             <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="wap_teamplate" id="wap_teamplate" class="form-control" value='<?php  echo S("system",'getSchoolWapTemplate',array($school_id)  );?>' />
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>  
                                              <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" name="pc_teamplate" id="pc_teamplate" class="form-control" value='<?php  echo S("system",'getSchoolPcTemplate',array($school_id)  );?>' />
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>                                                                  
                                        ...
                                        <div class="form-group form-md-line-input ">
                                           <label class="col-md-2 control-label">上学打卡时间</label>
                                            <div class="col-md-10 ">
                                                <div class="col-md-6">
                                                    <div class="form-group form-md-line-input  ">
                                                        <div class="input-icon col-md-8">
                                                            <input type="text"  name="beginToSchool" class="form-control" placeholder="00:00" value="<?php  echo $class_school->getSchoolParams('beginToSchool');?>"  >
                                                            <label for="beginToSchool">开始接受时间</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group form-md-line-input has-warning">
                                                        <div class="input-icon col-md-8">
                                                        <input type="text" name="endToSchool" class="form-control"  placeholder="12:00" value="<?php  echo $class_school->getSchoolParams('endToSchool');?>">
                                                        <label for="endToSchool">结束接受时间</label>
                                                    </div>
                                                    </div>
                                                </div>
                                            </div>                                                          
                                         ...
                                         <div class="form-group form-md-line-input ">
                                           <label class="col-md-2 control-label">放学打卡时间</label>
                                            <div class="col-md-10 ">
                                                <div class="col-md-6">
                                                    <div class="form-group form-md-line-input  ">
                                                        <div class="input-icon col-md-8">
                                                            <input type="text"  name="beginEndSchool" class="form-control" placeholder="12:00" value="<?php  echo $class_school->getSchoolParams('beginEndSchool');?>"  >
                                                            <label for="beginEndSchool">开始接受时间</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group form-md-line-input has-warning">
                                                        <div class="input-icon col-md-8">
                                                        <input type="text" name="endEndSchool" class="form-control" placeholder="24:00"  value="<?php  echo $class_school->getSchoolParams('endEndSchool');?>">
                                                        <label for="endEndSchool">结束接受时间</label>
                                                    </div>
                                                    </div>
                                                </div>
                                            </div>                                                          
