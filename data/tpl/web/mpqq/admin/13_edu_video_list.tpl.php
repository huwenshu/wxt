                                  ...
                                  <div class="portlet-body form">
                                    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" id="form1"  >
                                                ...
                                                <div id='href' class="form-group form-md-line-input" <?php  if($result['list_src_type']!=2 ) { ?> style="display:none"<?php  } ?>>
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input type="text" name="list_src_content"  class="form-control" value='<?php  echo $result['list_src_content'];?>' placeholder="http:// 或者 https://"  />
                                                    </div>
                                                </div> 
                                                    ...
                                                    <?php  if(is_array($video_list)) { foreach($video_list as $item) { ?>
                                                        <tr class="odd gradeX">
                                                           ...
                                                           <td>
                                                               ...
                                                               <a href="<?php  echo $this->createWebUrl('views_log', array('ac' => 'video_list','id'=>$item['list_id']))?>"  class="btn btn-outline btn-circle s btn-sm red"> <i class="fa fa-rss"></i>查看数：<?php  echo $item['views'];?></a>
                                                           </td>
                                                        </tr>                                           
                                                    <?php  } } ?>
