                                ...
                                <div class="portlet-title">
                                  ...
                                  <div class="portlet-body form">
                                    <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data" id="form1"  >
                                        ...
                                        <div class="form-group">
                                            <label class="col-xs-12 col-sm-3 col-md-2 control-label"><span class="required" aria-required="true"> * </span>教师电话</label>
                                            <div class="col-sm-9 col-xs-8">
                                                <input type="text" name="teacher_telphone" id="teacher_telphone" class="form-control" value='<?php  echo $result['teacher_telphone'];?>' />
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-xs-12 col-sm-3 col-md-2 control-label"><span class="required" aria-required="true"> * </span>教师邮箱</label>
                                            <div class="col-sm-9 col-xs-8">
                                        ...
                                        <div class="form-group">
                                            <label class="col-xs-12 col-sm-3 col-md-2 control-label"><span class="required" aria-required="true"> * </span>教师微信二维码</label>
                                            <div class="col-sm-9 col-xs-8">
                                        ...
                                        <div class='form-group'>
                                            ...
                                            <div class="col-sm-9 col-xs-12">
                                                <?php  if($ac=='edit') { ?>
                                                    <input type="text" class="form-control edited" readonly="" value="<?php  echo $result['passport'];?>" >
                                                <?php  } else { ?>
                                        ...
                                        <?php  if($ac=='edit') { ?>
                                            <div class='form-group'>
                                            <label class="col-xs-12 col-sm-3 col-md-2 control-label"><span class="required" aria-required="true"> * </span>状态</label>
                                            <div class="col-sm-9 col-xs-8">
