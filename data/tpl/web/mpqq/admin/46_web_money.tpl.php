                                        ...
                                        <tbody>
                                            <?php  if(is_array($list)) { foreach($list as $row) { ?>
                                                <tr>
                                                    ...
                                                    <td><a href="<?php  echo $this->createWebUrl('money',array('id'=>$row['limit_id'],'ac'=>'edit','aw'=>1) )?>" class="btn btn-outline btn-circle dark btn-sm black"> <i class="fa fa-edit"></i>编辑</a>
