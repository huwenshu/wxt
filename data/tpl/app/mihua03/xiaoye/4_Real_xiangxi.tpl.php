...
<div class="z_main">
  <form action=" " method="POST">
    <div class="b3-t">
	<div class="kzk"></div>
    <li id='head_img' <?php  if($result['student_img']) { ?> style="background-image: url(<?php  echo $this->imgFrom($result['student_img']);?>);" <?php  } ?>><a href="javascript:;" id='chooseImage'><img src="<?php echo MODULE_URL;?>/template/xiaoye/upimg/zp.png"></a></li>
	</div>
	<div class="sq">
		<div class="sq-tf">
        ...
        <div class="sq-tf">
			...
			<input style="width: 432px;" class="sq-t2f" name='address'    value='<?php  echo $result['address'];?>' >
		</div>
        <div class="sq-tf">
		...
		<div class="sq-tf">
			<p class="sq-11">关系</p>
				...
				<select name='relation' class="sq-t23" style="-webkit-appearance: none;  ">
