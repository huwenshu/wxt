            ...
            <ul class="z_txx">
                <?php  if(is_array($teacher_list)) { foreach($teacher_list as $key => $row) { ?>
                    <li>
                        ...
                        <div class="z_txx2"><?php  echo $row['teacher_realname'];?><span>(<?php  echo $this->courseName($row['course_id'])?>)</span></div>
                        <div class="z_txx3"><a href="tel:<?php  echo $row['teacher_telphone'];?>"><img src="<?php echo MODULE_URL;?>/template/xiaoye/img/Z_DH.png"></a></div>
                        <div class="z_txx3"><a href="<?php  echo $this->createMobileUrl('chatMessage',array('t_id'=>$row['teacher_id'],'type'=>'teacher'))?>"><img src="<?php echo MODULE_URL;?>/template/xiaoye/img/pl.png"></a></div>
                    </li>
                <?php  } } ?>
            </ul>
        </div>
