 ...
 <div id="firstpane" class="menu_list">
    ...
    <div style="display:block" class="menu_body">
        ...
        <?php  if(is_array($arr)) { foreach($arr as $row) { ?>
            <li>
                <a href="<?php  echo $this->createMobileUrl('give_money_order',array('name'=>$row['limit_module']));?>">
	    		<div class="z_pp1">
  			        <input type="checkbox" id="checkbox-21"><label for="checkbox-21">✔</label>
  		        </div>
	    		<div class="z_txx2"><?php  echo $row['name'];?>:<?php  echo $row['money'];?></div>
                </a>
	    	</li>
        <?php  } } ?>
         <?php  if(!$arr) { ?>
