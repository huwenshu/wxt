...
<body>
    <div class="z_main">
        <div class="b4t">
            <li class="b4-t"><img src="<?php  echo $img;?>"></li>
            <li class="btw1">
            ...
            <?php  if(is_array($video_list)) { foreach($video_list as $row) { ?>
                <li class="ps" style="margin-top:10px;">
                    <?php  if($row['video_type']==1) { ?>
                        <video width="908" height="454" controls poster="<?php  echo $_W['attachurl'];?>/<?php  echo $row['video_img'];?>">
                                <source src="<?php  echo $row['video_url'];?>" type="video/m3u8">
                        </video>
